...
7.  **REPORT: Proof-of-Load**: Submit a detailed Markdown summary containing:
    ...
    - (h) Possibly-stale Project Knowledge: files whose indexed domain matches a `## Active Expertise` domain and whose age exceeds 90 days, listed with their age, or an explicit confirmation that none are flagged. This is advisory and never blocks work.
