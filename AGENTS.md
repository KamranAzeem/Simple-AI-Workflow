...
1. [online policy file](https://github.com/KamranAzeem/Smart-AI-Workflow/blob/master/ai/ai-policy-cloud.md) - operating rules and guardrails. If unreachable, then read the local policy file mentioned in the next point.
