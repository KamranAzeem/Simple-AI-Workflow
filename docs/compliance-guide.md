...
To enable a compliance policy for a project, update your project `ai-customization.md` file (at the project root):

1. Open `ai-customization.md` (create it if it doesn't exist).
